...
# gcc 4.4
extracflags="-O3 -march=skylake -Wall -D_REENTRANT -fmerge-all-constants" # -funroll-loops -fvariable-expansion-in-unroller -fbranch-target-load-optimize2 -fsched2-use-superblocks -falign-loops=16 -falign-functions=16 -falign-jumps=16 -falign-labels=16"
...
mkdir -p deploy
mv cpuminer.exe deploy/cpuminer-opt-skylake.exe